...
//        }
        ...
        try {
            ...
            dateToUse = LocalDate.now(ZoneId.systemDefault()).with(TemporalAdjusters.previous(DayOfWeek.SUNDAY));
            ...
            dateToUse = LocalDate.now(ZoneId.systemDefault()).with(TemporalAdjusters.previous(DayOfWeek.MONDAY));
            ...
            json = "{\"company\":\"" + company + "\",\"emp_id\":0,\"emp_name\":\"french\","
                    + "\"emp_no\":\"bdfvksNew\",\"hire_date\":" + "\"" + dateStr
                    + "\",\"job\":\"new job\",\"salary\":60000.0," + "\"dept_id\":" + dept_id + ",\"mng_id\":0}";
            ...
            json = "{\"company\":\"" + company + "\",\"emp_id\":" + emp_id + ",\"emp_name\":\"french\","
                    + "\"emp_no\":\"bdfvksTest\",\"hire_date\":" + "\"" + dateStr
                    + "\",\"job\":\"new job\",\"salary\":60000.0," + "\"dept_id\":" + dept_id + ",\"mng_id\":0}";
